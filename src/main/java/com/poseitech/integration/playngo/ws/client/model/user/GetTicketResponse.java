...
public class GetTicketResponse implements org.apache.axis2.databinding.ADBBean {
   ...
   public static class Factory {
      private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(GetTicketResponse.Factory.class);
       ...
       */
      public static GetTicketResponse parse(
         ...
         try {
            ...
            if (reader.getAttributeValue(
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"GetTicketResponse".equals(type)) {
                     ...
                     return (GetTicketResponse) ExtensionMapper.getTypeObject(nsUri,
                           type, reader);
                  }
               }
            }
            ...
            if ((reader.isStartElement() &&
                  new javax.xml.namespace.QName(
                        "http://playngo.com/v1", "Ticket").equals(
                        reader.getName())) ||
                  new javax.xml.namespace.QName("", "Ticket").equals(
                        reader.getName())) {
