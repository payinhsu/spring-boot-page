...
public class GetTicket implements org.apache.axis2.databinding.ADBBean {
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                  ...
                  namespacePrefix + ":GetTicket", xmlWriter);
         } else {
            writeAttribute("xsi",
                  "http://www.w3.org/2001/XMLSchema-instance", "type",
                  "GetTicket", xmlWriter);
   ...
   public static class Factory {
      private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(GetTicket.Factory.class);
            ...
            if (reader.getAttributeValue(
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"GetTicket".equals(type)) {
                     ...
                     return (GetTicket) ExtensionMapper.getTypeObject(nsUri,
                           type, reader);
                  }
               }
            }
