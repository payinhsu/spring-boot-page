...
/**
 * GetTriggeredAchievementsByPlayer bean class
 */
public class GetTriggeredAchievementsByPlayer implements org.apache.axis2.databinding.ADBBean {
   public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://playngo.com/v1",
         "GetTriggeredAchievementsByPlayer", "ns3");
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                  ...
                  namespacePrefix + ":GetTriggeredAchievementsByPlayer",
                  xmlWriter);
         } else {
            writeAttribute("xsi",
                  "http://www.w3.org/2001/XMLSchema-instance", "type",
                  "GetTriggeredAchievementsByPlayer", xmlWriter);
         }
      }
   ...
   public static class Factory {
      private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(GetTriggeredAchievementsByPlayer.Factory.class);
       ...
       */
      public static GetTriggeredAchievementsByPlayer parse(
            javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
         GetTriggeredAchievementsByPlayer object = new GetTriggeredAchievementsByPlayer();
         ...
         try {
            ...
            if (reader.getAttributeValue(
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"GetTriggeredAchievementsByPlayer".equals(type)) {
                     //find namespace for the prefix
                     java.lang.String nsUri = reader.getNamespaceContext()
                           .getNamespaceURI(nsPrefix);

                     return (GetTriggeredAchievementsByPlayer) ExtensionMapper.getTypeObject(nsUri,
                           type, reader);
                  }
               }
            }
