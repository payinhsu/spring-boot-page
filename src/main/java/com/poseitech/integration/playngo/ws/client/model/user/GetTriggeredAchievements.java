...
/**
 * GetTriggeredAchievements bean class
 */
public class GetTriggeredAchievements implements org.apache.axis2.databinding.ADBBean {
   public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://playngo.com/v1",
         "GetTriggeredAchievements", "ns3");
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                  ...
                  namespacePrefix + ":GetTriggeredAchievements", xmlWriter);
         } else {
            writeAttribute("xsi",
                  "http://www.w3.org/2001/XMLSchema-instance", "type",
                  "GetTriggeredAchievements", xmlWriter);
         }
      }
   ...
   public static class Factory {
      private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(GetTriggeredAchievements.Factory.class);
       ...
       */
      public static GetTriggeredAchievements parse(
            javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
         GetTriggeredAchievements object = new GetTriggeredAchievements();
         ...
         try {
            ...
            if (reader.getAttributeValue(
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"GetTriggeredAchievements".equals(type)) {
                     //find namespace for the prefix
                     java.lang.String nsUri = reader.getNamespaceContext()
                           .getNamespaceURI(nsPrefix);

                     return (GetTriggeredAchievements) ExtensionMapper.getTypeObject(nsUri,
                           type, reader);
                  }
               }
            }
