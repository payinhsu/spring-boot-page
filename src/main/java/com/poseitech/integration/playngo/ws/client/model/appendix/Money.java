...
public class Money implements org.apache.axis2.databinding.ADBBean {
   ...
   public void serialize(final javax.xml.namespace.QName parentQName,
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                  ...
                  namespacePrefix + ":Money", xmlWriter);
         } else {
            writeAttribute("xsi",
                  "http://www.w3.org/2001/XMLSchema-instance", "type",
                  "Money", xmlWriter);
      ...
      localCurrency.serialize(new javax.xml.namespace.QName(
            "http://playngo.com/v1", "Currency"), xmlWriter);
   ...
   public static class Factory {
      private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(Money.Factory.class);
       ...
       */
      public static Money parse(javax.xml.stream.XMLStreamReader reader)
         ...
         try {
            ...
            if (reader.getAttributeValue(
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"Money".equals(type)) {
                     ...
                     return (Money) ExtensionMapper.getTypeObject(nsUri,
                           type, reader);
                  }
               }
            }
            ...
            if ((reader.isStartElement() &&
                  new javax.xml.namespace.QName(
                        "http://playngo.com/v1", "Value").equals(
                        reader.getName())) ||
