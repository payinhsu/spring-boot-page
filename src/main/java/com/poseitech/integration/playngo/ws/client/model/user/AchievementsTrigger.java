...
/**
 * AchievementsTrigger bean class
 */
public class AchievementsTrigger implements org.apache.axis2.databinding.ADBBean {
        /* This type was generated from the piece of schema that had
           name = AchievementsTrigger
   ...
   public void setSpin(int param) {
      ...
      localSpinTracker = param != java.lang.Integer.MIN_VALUE;
   ...
   public void setResultId(int param) {
      // setting primitive attribute tracker to true
      localResultIdTracker = param != java.lang.Integer.MIN_VALUE;
      ...
      if (serializeType) {
         ...
         if ((namespacePrefix != null) &&
            ...
            writeAttribute("xsi",
                  ...
                  namespacePrefix + ":AchievementsTrigger", xmlWriter);
         } else {
            writeAttribute("xsi",
                  "http://www.w3.org/2001/XMLSchema-instance", "type",
   ...
   public static class Factory {
      private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(AchievementsTrigger.Factory.class);
       ...
       */
      public static AchievementsTrigger parse(
            javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
         AchievementsTrigger object = new AchievementsTrigger();
         ...
         try {
            ...
            if (reader.getAttributeValue(
               ...
               if (fullTypeName != null) {
                  ...
                  if (!"AchievementsTrigger".equals(type)) {
                     //find namespace for the prefix
                     java.lang.String nsUri = reader.getNamespaceContext()
                           .getNamespaceURI(nsPrefix);

                     return (AchievementsTrigger) ExtensionMapper.getTypeObject(nsUri,
                           type, reader);
                  }
               }
            }
            ...
            if ((reader.isStartElement() &&
                  new javax.xml.namespace.QName(
                        "http://playngo.com/v1", "Description").equals(
                        reader.getName())) ||
            ...
            if ((reader.isStartElement() &&
               ...
               if ("true".equals(nillableValue) ||
                     "1".equals(nillableValue)) {
                  throw new org.apache.axis2.databinding.ADBException(
                        "The element: " + "Spin" + "  cannot be null");
               }
